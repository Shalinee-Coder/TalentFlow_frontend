...
<aside class="tf-sidebar">
  <!-- Brand Logo -->
  <div class="tf-brand">
    <div class="tf-brand-icon">
      <svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z"/>
      </svg>
    </div>
    <span class="tf-brand-name">TalentFlow</span>
  </div>

  <!-- Navigation Section -->
  <nav class="tf-nav-section">
    <div class="tf-nav-item active" data-view="dashboard">
    ...
    <div class="tf-nav-item" data-view="jobs">
    ...
    <div class="tf-nav-item" data-view="candidates">
    ...
    <div class="tf-nav-item" data-view="pipeline">
    ...
    <div class="tf-nav-item" data-view="interviews">
    ...
    <div class="tf-nav-item" data-view="notifications">
      ...
      Notifications
      <span id="tfSidebarNotificationBadge" class="tf-nav-badge">0</span>
    </div>

    <div class="tf-nav-item" data-view="tasks">
      <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"/></svg>
      Technical Tasks
    </div>
  </nav>

  <!-- Sidebar Footer Pro Box & User Switcher -->
  <div class="tf-sidebar-footer">
    <div class="tf-pro-card">
      <h4>
        <svg width="16" height="16" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
        Scoring Engine
      </h4>
      <p>Transparent 100-point matching on skills, experience & education.</p>
      <button class="tf-btn-gradient" onclick="TF.switchView('candidates')">
        AI Resume Parser
      </button>
    </div>

    <div class="tf-logout-btn" onclick="TF.openAuthModal()" title="Switch account or sign out">
